...
class ProfileController extends Controller
{
    ...
    public function picture(Request $request){
        ...
        $new_name = "Zaifi-" . microtime(true) . "." . $request->picture->extension();
        ...
        $is_updated ? $message = ['success' => 'Picture has been successfully updated!'] : $message = ['failure' => 'Picture has failed to update!'];
